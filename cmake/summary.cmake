...
if(APPLE)
message(STATUS "    - ObjC++ compilier version:    ${CMAKE_OBJCXX_COMPILER_VERSION}")
message(STATUS "    - ObjC++ compilier:            ${CMAKE_OBJCXX_COMPILER}")
message(STATUS "    - ObjC++ compilier flags:      ${CMAKE_OBJCXX_FLAGS}")
endif(APPLE)
