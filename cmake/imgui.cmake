...
if (NOT IMGUI_PLATFORM)
    ...
    if (UNIX AND (NOT (MINGW OR APPLE)))
        ...
        if (SDL3_FOUND AND (NOT IMGUI_PLATFORM))
            set (IMGUI_PLATFORM SDL3)
        endif()
        if(NOT IMGUI_PLATFORM)
...
if(NOT IMGUI_RENDERER)
    ...
    if (IMGUI_PLATFORM MATCHES SDL2 OR IMGUI_PLATFORM MATCHES SDL3)
...
if (IMGUI_PLATFORM)
    ...
    elseif (IMGUI_PLATFORM MATCHES SDL3)
        target_sources (IMGUI INTERFACE ${IMGUI_BASE_DIR}/backends/imgui_impl_sdl3.cpp)
